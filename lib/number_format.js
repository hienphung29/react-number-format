...
var propTypes = {
  ...
  isLabel: _propTypes["default"].bool
};
var defaultProps = {
  displayType: 'input',
  decimalSeparator: '.',
  ...
  _createClass(NumberFormat, [{
    ...
    value: function updateValueIfRequired(prevProps) {
      ...
      if (prevProps !== props) {
        ...
        var shouldUpdateValue = (!isNaN(floatValue) || !isNaN(lastFloatValue)) && floatValue !== lastFloatValue || //while typing set state only when float value changes
    ...
    value: function formatAsNumber(numStr) {
      ...
      var hasValidAfterDecimal = isLabel && !fixedDecimalScale ? afterDecimal !== '' && parseInt(afterDecimal, 10) > 0 : true;
      var hasDecimalSeparator = hasValidAfterDecimal && (numStr.indexOf('.') !== -1 || decimalScale && fixedDecimalScale); //add prefix and suffix
